    ...
    public sealed class ArcadeStickVisibilityUpdater : PresenterBase
    {
        ...
        private bool IsArcadeStickVisible()
        {
            ...
            var settingBasedResult =
                ...
                _bodyMotionModeController.GamepadMotionMode.CurrentValue is GamepadMotionModes.ArcadeStick;
            ...
            return
                ...
                _handIkIntegrator.LeftTargetType.CurrentValue is HandTargetType.ArcadeStick ||
                _handIkIntegrator.RightTargetType.CurrentValue is HandTargetType.ArcadeStick;
        }
    }
}
