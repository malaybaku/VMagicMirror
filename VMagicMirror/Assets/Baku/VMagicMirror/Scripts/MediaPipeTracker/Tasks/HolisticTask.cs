...
namespace Baku.VMagicMirror.MediaPipeTracker
{
    ...
    public class HolisticTask : MediaPipeTrackerTaskBase
    {
        ...
        public void SetBlendShapeOutputActive(bool active)
        {
            ...
            // 手だけトラッキングしてるときはRestartする意味がないのでやらない
            if (_taskMode is HolisticTaskMode.FaceAndHand or HolisticTaskMode.FaceHandAndElbow)
            {
                RestartTaskIfActive();
            }
        }
        ...
        {
            _isRunningWithBlendShapeOutput =
                (_taskMode is HolisticTaskMode.FaceAndHand or HolisticTaskMode.FaceHandAndElbow) &&
                _blendShapeOutputActive;
