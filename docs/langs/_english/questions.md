...
VRM 1.0 is not supported in VMagicMirror v2.0.10, and VRM 1.0 support will be released in 2022.

Please use VRM 0.x model in current v2.0.10 and older version.
