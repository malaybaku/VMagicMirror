...
* 追加: `サブキャラ` 機能として、通常のアバターに加えて別途キャラクターを表示できる機能を追加しました。詳細は [サブキャラ](../buddy) を参照してください。
...
なお、上記の更新のうち VMC Protocolによるデータ送信、サブキャラ、ハンドトラッキング機能はエディション差による制限があります。詳細は [ダウンロード](../downloads) のページを参照してください。
