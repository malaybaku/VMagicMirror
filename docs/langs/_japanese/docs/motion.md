...
`肩モーションの補正を有効化`: タイピングやマウス操作などの腕の動きに合わせて、肩を動かす補正を有効にします。デフォルトで有効ですが、アバターとの相性が悪い場合はオフにします。

`肩の上がり具合を調整`: 肩モーションの補正が有効なとき、肩の上がり方を調整します。値を大きくすると肩が上がりやすくなり、小さくすると肩が下がりやすくなります。

`背中を曲げる`: 背中の曲げ伸ばしを調整します。アバターの姿勢が前かがみ、または反りすぎて見える場合に調整します。
