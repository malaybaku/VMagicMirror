...
推奨事項として、できれば送信側ソフトではVMagicMirrorで使っているものと同一のVRMをロードして下さい。

<div class="note-area" markdown="1">

**NOTE**

VMagicMirrorでは送信側ソフトで異なるアバターを使っている可能性も想定して受信した姿勢データを処理します。

もし見た目に違和感がない場合、送信側ソフトでVMagicMirrorで異なるアバターを表示して本機能を使っても差し支えありません。
...
- `受信したポーズを滑らかに適用`: オンにすると、姿勢の平滑化をしながら受信したポーズを適用します。VMagicMirror上でアバターの動きがカクカクする場合はオンに、そうでない場合はオフにすることを推奨しています。
- `背骨・頭ボーンに受信したポーズとトラッキング結果を両方とも適用`: オンにすると、VMC Protocolで受信した姿勢に加えてwebカメラなどでトラッキングした姿勢も適用します。立ちポーズを受信している場合などにオンにします。
