...
* 追加: カメラによるハンドトラッキング機能を刷新し、やや高精度な動作を意図したものに変更しました。ただし基本エディションの場合、ハンドトラッキングを有効化している間はキャラクターウィンドウに専用のエフェクトが適用されます。
* 追加: iOSでのトラッキングについて`左右反転をオフ`オプションをサポートしました。
* 追加: 簡体字中国語の翻訳を追加しました。
